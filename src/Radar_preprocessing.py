...
# TUDE_NAME = {"TrackUpdateTime": "ts", "380_md_S": "icao", "105_lat": "lat", "105_long": "lon", "136_md_C": "alt", "135_calc_height": "alt_backup",\
#     "380_TAS_knots":"spd", "380_SFL": "SFL", "380_Ground_Speed_knots": "gnd_spd", "380_Mach": "Mach", "xxx_calculated_ground_speed_knots": "calc_gnd_spd",\
#     "FileDate":"FileDate", "220_rate_climb_ft_min":"roc"}
...
if __name__ == '__main__':
    ...
    # parser.add_argument("--columns", nargs="*", type=str, default=['ts', 'alt', 'spd', 'roc'], help="The labels of the columns that need to be preprocessed.")
    ...
    processed_csvs = os.listdir(path = f"{folder}_preprocessed/csvs")
    ...
    for i, df in enumerate(dfs):
        ...
        # To note here, columns to include should only be integers. 

        # i1 = df[['alt', 'spd', 'roc']].apply(pd.Series.first_valid_index).max()
        # i2 = df[['alt', 'spd', 'roc']].apply(pd.Series.last_valid_index).min()

        # i1 = df[['alt', 'spd', 'roc', "SFL", "Mach", "gnd_spd"]].apply(pd.Series.first_valid_index).max()
        # i2 = df[['alt', 'spd', 'roc', "SFL", "Mach", "gnd_spd"]].apply(pd.Series.last_valid_index).min()
        ...
        df.loc[:, 'alt'] = df['alt'] * 3.28084  # m -> ft Might need to check this one
        ...
        # "105_long": "lon", 
        # "136_md_C": "alt", 
        # "135_calc_height": "alt_backup",
        # "380_TAS_knots":"spd", 
        # "380_SFL": "SFL", 
        # "380_Ground_Speed_knots": "gnd_spd",
        # "380_Mach": "Mach",
        # "xxx_calculated_ground_speed_knots": "calc_gnd_spd",
        # "FileDate":"FileDate", 
        # "220_rate_climb_ft_min":"roc"